...
public class BattleRenderTextureComponent : SensorComponent
{
    BattleRenderTexture m_Sensor;
    ...
    {
        m_Sensor = new BattleRenderTexture(RenderTexture, Grayscale, SensorName, m_Compression);
